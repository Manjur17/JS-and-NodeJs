...
//handling rejectHandler for every then() is cumbersome
...
download("www.xyz.com")
    .then(
        ...
        function downloadreject(value) {
            ...
            throw value //now writereject will be called as rejected
        }
    )
    .then(
        ...
        function writereject(value) {
            ...
            throw value //now uploadreject will be called as rejected
            //if we don't throw value then processUpload() will be called as it threats it as resolve promise with value : undefined
        }
    )
    .then(
