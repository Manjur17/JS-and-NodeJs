...
async function steps() {
  ...
  //const data = await 10; this is treated as resolved promise and data = 10;
...
//with yield we needed iter.next() to get the value but steps() handles the iterator automatically
